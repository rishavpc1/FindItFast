...
bigFont=pygame.font.Font(c,80)
smallFont=pygame.font.Font(c,40)
kingFont=pygame.font.Font(c,80)
kingFont1=pygame.font.Font(c,35)
kingFont2=pygame.font.Font(c,80)
kingFont3=pygame.font.Font(c,50)
kingFont4=pygame.font.Font(c,80)
varFont=pygame.font.Font(c,80)
wauFont=pygame.font.Font(c,120)
timer_font=pygame.font.Font(c,100)
...
elapsed=0
message=""
level_change= [0 for x in xrange(10)]
def level_timer():
        global max_time,level_change
        for i in range(0,10):
                level_change[i]=max_time
                max_time-=1

level_time=0
Matrix = [[0 for x in xrange(4)] for x in xrange(4)]
point=0
Hash = [0 for x in xrange(201)]
...
def add_num():
        ...
        for i in range(0,4):
                for p in range(0,4):    
                        ...
                        Matrix[p][i]=add_num
                #print Matrix[p][i]
randomNum = [0 for x in xrange(10)]

def num_challenge():
        global randomNum,Matrix
        for z in range(0,10):
                find_numX=randint(0,3)
                find_numY=randint(0,3)
...
class Mainwindow:
        def draw(self):
                ...
                search=pygame.image.load('bg.jpg')
                search = pygame.transform.scale(search, (1000, 600))
...
class Game:
        ...
        def draw(self):
                ...
                window.fill(WHITE)
                pygame.display.set_caption("Find it Fast")
                back=pygame.image.load('pic.jpg')
...
class Help:
        def draw(self):
                ...
                search1=pygame.image.load('pic.jpg')
                search1= pygame.transform.scale(search1, (1000, 600))
                bigFont=pygame.font.Font(c,25)
...
class Credits:
        def draw(self):
                ...
                search1=pygame.image.load('bg.jpg')
                search1= pygame.transform.scale(search1, (1000, 600))
                bigFont=pygame.font.Font(c,25)
                text=smallFont.render(text,False,(255,255,0))
                ctextdisp=text.get_rect()
                ctextdisp.center=(500,550)
                text4=bigFont.render(text1,False,(255,255,255))
                textdisp3=text4.get_rect()
                textdisp3.center=(500,400)
                text5=bigFont.render(text2,False,(255,255,255))
                textdisp1=text5.get_rect()
                textdisp1.center=(100,400)
                text6=bigFont.render(text3,False,(255,255,255))
                textdisp2=text6.get_rect()
                textdisp2.center=(900,400)
                text7=bigFont.render('',False,(255,255,255))
                textdisp6=text7.get_rect()
                textdisp6.center=(500,450)
                text8=bigFont.render('',False,(255,255,255))
                textdisp4=text8.get_rect()
                textdisp4.center=(100,450)
                text9=bigFont.render('',False,(255,255,255))
                textdisp5=text9.get_rect()
                textdisp5.center=(900,450)
                credits.blit(search1,(0,0))
                credits.blit(heading1,texthead1)
                credits.blit(text4,textdisp3)
                credits.blit(text5,textdisp1)
                credits.blit(text6,textdisp2)
                credits.blit(text7,textdisp6)
                credits.blit(text8,textdisp4)
                credits.blit(text9,textdisp5)
